...
-- BEGIN;
-- LOAD DATA INFILE '/Users/gabrielsong/hrsf125/vr-carousel/server/db/listings.csv' INTO TABLE vacayhome.listing 
...
ALTER TABLE vacayhome.photo DISABLE KEYS;
BEGIN;
LOAD DATA INFILE '/Users/gabrielsong/hrsf125/vr-carousel/server/db/photos.part1.csv' INTO TABLE vacayhome.photo
  FIELDS
